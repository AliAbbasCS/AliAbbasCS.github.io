<?php
require "../daltech-html/Components/title-header.php"
?>
...
<!-- Mirrored from modinatheme.com/html/daltech-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 05:02:47 GMT -->
...
<head>
    ...
    <!-- ======== Page title ============ -->
    <title>DalTech | <?php echo (constant("siteTitle")) ?></title>
    <!--<< Favcion >>-->
...
<body>
                        ...
                        <div class="col-lg-8">
                            <div class="hero-content">
                                ...
                                <div class="hero-button">
                                    <a href="service-details.html" class="theme-btn hover-white fs-lg animated"
                    ...
                    <div class="col-lg-6">
                        <div class="about-image-items">
                            <div class="circle-shape">
                                <img src="assets/img/about/circle.png" alt="img" class="text-circle">
                                <div class="award-img">
    ...
    <section class="service-section fix section-padding section-bg">
        ...
        <div class="container">
            <div class="title-section-area">
                <div class="section-title">
                    <span class="wow fadeInUp">our most premium services</span>
                    <h2 class="wow fadeInUp" data-wow-delay=".3s">
                        Most experienced <br>
                        our services
                    </h2>
                </div>
                <a href="service-details.html" class="theme-btn wow fadeInUp" data-wow-delay=".5s">
                    <span>
                        Explore Our Service
                        <i class="fas fa-chevron-right"></i>
                    </span>
                ...
                <div class="service-card-items">
                    <div class="service-content">
                        ...
                        <div class="content">
                            <h4>02</h4>
                            <h3>
                                <a href="service-details.html">it managment</a>
                            </h3>
                            <p>
                                Sed ut perspiciatis unde is <br>
                                voluptatem accusant
                ...
                <div class="service-card-items">
                    <div class="service-content">
                        ...
                        <div class="content">
                            <h4>03</h4>
                            <h3>
                                <a href="service-details.html">desktop computing</a>
                            </h3>
                            <p>
                                Sed ut perspiciatis unde is <br>
                                voluptatem accusant
        ...
        <div class="container">
            <div class="trusted-client-wrapper">
                <div class="row align-items-center">
                    <div class="col-xl-5">
                        <div class="trusted-client-image bg-cover"
                            style="background-image: url('assets/img/feature/trusted.jpg');">
                            <div class="icon-box">
                    ...
                    <div class="col-xl-7 mt-5 mt-xl-0">
                        <div class="trusted-content">
                            ...
                            <p class="mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                Transmds is the world’s driving worldwide coordinations supplier — we <br> uphold
                            ...
                            <div class="single-tab-items">
                                <ul class="nav mb-4" role="tablist">
                                    ...
                                    <li class="nav-item wow fadeInUp" data-wow-delay=".5s" role="presentation">
                                        <a href="#strategy" data-bs-toggle="tab" class="nav-link" aria-selected="false"
                                            role="tab" tabindex="-1">
                                            Our Strategy
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInUp" data-wow-delay=".7s" role="presentation">
                                        <a href="#vision" data-bs-toggle="tab" class="nav-link" aria-selected="false"
                                            role="tab" tabindex="-1">
                                            our vision
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div id="mission" class="tab-pane fade show active" role="tabpanel">
                                        <div class="tab-content-items">
                                            ...
                                            <div class="icon-area">
                                                <div class="icon-items d-flex align-items-center gap-3 wow fadeInUp"
                                                    data-wow-delay=".5s">
                                                    <div class="icon">
                                    ...
                                    <div id="strategy" class="tab-pane fade" role="tabpanel">
                                        <div class="tab-content-items">
                                            ...
                                            <div class="icon-area">
                                                <div class="icon-items d-flex align-items-center gap-3">
                                                    <div class="icon">
                                                        <i class="flaticon-microchip"></i>
                                                    </div>
                                                    <h6>Artificial intelligence</h6>
    ...
    <section class="cta-banner-section bg-cover section-padding"
            ...
            <div class="marquee-inner to-left">
                <ul class="marqee-list d-flex">
                    <li class="marquee-item">
                        <span class="text-slider">arketing</span><span class="text-slider">Eit</span><span
                            class="text-slider style-border"></span>
                        <span class="text-slider">Co</span><span class="text-slider">advisor</span><span
                            class="text-slider style-border"></span><span class="text-slider">it</span><span
                            class="text-slider">consultancy</span><span class="text-slider style-border"></span><span
                            class="text-slider">Data</span><span class="text-slider">recover</span>
                        <span class="text-slider">arketing</span><span class="text-slider">Eit</span><span
                            class="text-slider style-border"></span>
                        <span class="text-slider">Co</span><span class="text-slider">advisor</span><span
                            class="text-slider style-border"></span><span class="text-slider">it</span><span
        ...
        <div class="container">
            ...
            <div class="testimonial-carousel-active">
                <div class="testimonial-card-items">
                    <div class="author-items">
                        <div class="author-image bg-cover"
                            style="background-image: url('assets/img/testimonial/01.png');"></div>
                ...
                <div class="testimonial-card-items">
                    <div class="author-items">
                        <div class="author-image bg-cover"
                            style="background-image: url('assets/img/testimonial/03.png');"></div>
                        <div class="author-content">
                            <h5>Jhon Dev</h5>
    ...
    <footer class="footer-section footer-bg section-padding pb-0 bg-darken corner">
        <div class="container">
                ...
                <div class="col-lg-7">
                    <div class="newsletter-area">
                        ...
                        <div class="newsletter-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay=".5s">We Provide Best Pricing package to grow your
                                lead capture</p>
                        </div>
        ...
        <div class="footer-bottom bg-darken">
            <div class="container">
                <div class="footer-wrapper d-flex align-items-center justify-content-between">
                    <p class="wow fadeInLeft color-2" data-wow-delay=".3s">
                        Copyright © 2024 <a href="index-2.html">Modinatheme</a>. All Rights Reserved.
                    </p>
...
<!-- Mirrored from modinatheme.com/html/daltech-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 05:03:17 GMT -->
