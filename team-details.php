...
<!-- Mirrored from modinatheme.com/html/daltech-html/team-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 05:03:52 GMT -->
<head>
        <!-- ========== Meta Tags ========== -->
        <meta charset="UTF-8">
    ...
    <body>
                        ...
                        <div class="offcanvas__contact">
                            ...
                            <ul>
                                ...
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="mailto:info@azent.com"><span class="mailto:info@azent.com">info@azent.com</span></a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    <div class="offcanvas__contact-icon mr-15">
        ...
        <div class="header-top-section-3">
            <div class="container-fluid">
                <div class="header-top-wrapper style-2 style-3 color-style">
                    <div class="top-left">
                        <ul class="contact-list">
                            <li>
                                <span>Call</span>Consult With It Advisor? <a href="contact.html">Click Now</a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <a href="mailto:info@example.com" class="line-none">info@example.com</a> 
                            </li>
                        </ul>
                    </div>
                    <div class="top-right">
                                        ...
                                        <nav id="mobile-menu">
                                            <ul>
                                                <li class="has-dropdown active menu-thumb">
                                                    ...
                                                    <ul class="submenu has-home-menu d-none d-lg-block">
                                                        <li class="border-none">
                                                            <div class="row g-4">
                                                                <div class="col-lg-4 home-menu">
                                                ...
                                                <li>
                                                    <a href="service.html">Services <i class="fas fa-angle-down"></i>
                                                  </a>
                                                    <ul class="submenu">
                ...
                <div class="team-details-wrapper">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="team-image bg-cover" style="background-image: url('assets/img/team/details-1.jpg');"></div>
                        </div>
